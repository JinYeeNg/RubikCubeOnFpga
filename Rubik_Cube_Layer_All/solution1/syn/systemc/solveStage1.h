...
#ifndef _solveStage1_HH_
#define _solveStage1_HH_
...
struct solveStage1 : public sc_module {
    ...
    // Module declarations
    solveStage1(sc_module_name name);
    SC_HAS_PROCESS(solveStage1);
    ...
    sc_signal< sc_lv<4> > edgeNumber_V_read_read_fu_46_p2;
    sc_signal< sc_lv<1> > grp_fu_82_p2;
    sc_signal< sc_lv<1> > tmp_51_reg_92;
    sc_signal< sc_logic > ap_CS_fsm_state30;
    sc_signal< sc_lv<1> > tmp_s_reg_96;
    sc_signal< sc_logic > ap_CS_fsm_state41;
    sc_signal< sc_lv<1> > tmp_52_reg_100;
    sc_signal< sc_logic > ap_CS_fsm_state77;
    sc_signal< sc_logic > grp_turnCube_fu_60_ap_start;
    sc_signal< sc_logic > grp_turnCube_fu_60_ap_done;
    sc_signal< sc_logic > grp_turnCube_fu_60_ap_idle;
    sc_signal< sc_logic > grp_turnCube_fu_60_ap_ready;
    sc_signal< sc_lv<4> > grp_turnCube_fu_60_turn_V;
    sc_signal< sc_lv<8> > grp_turnCube_fu_60_moveCounter_V_o;
    sc_signal< sc_logic > grp_turnCube_fu_60_moveCounter_V_o_ap_vld;
    sc_signal< sc_lv<8> > grp_turnCube_fu_60_moves_V_address0;
    sc_signal< sc_logic > grp_turnCube_fu_60_moves_V_ce0;
    sc_signal< sc_logic > grp_turnCube_fu_60_moves_V_we0;
    sc_signal< sc_lv<4> > grp_turnCube_fu_60_moves_V_d0;
    sc_signal< sc_lv<6> > grp_turnCube_fu_60_cubieColor_V_address0;
    sc_signal< sc_logic > grp_turnCube_fu_60_cubieColor_V_ce0;
    sc_signal< sc_logic > grp_turnCube_fu_60_cubieColor_V_we0;
    sc_signal< sc_lv<3> > grp_turnCube_fu_60_cubieColor_V_d0;
    sc_signal< sc_lv<6> > grp_turnCube_fu_60_cubieColor_V_address1;
    sc_signal< sc_logic > grp_turnCube_fu_60_cubieColor_V_ce1;
    sc_signal< sc_logic > grp_turnCube_fu_60_cubieColor_V_we1;
    sc_signal< sc_lv<3> > grp_turnCube_fu_60_cubieColor_V_d1;
    sc_signal< sc_logic > grp_turnCube_fu_60_ap_start_reg;
    ...
    sc_signal< bool > ap_predicate_op137_call_state32;
    ...
    void thread_ap_done();
    void thread_ap_idle();
    void thread_ap_predicate_op137_call_state32();
    ...
    void thread_edgeNumber_V_read_read_fu_46_p2();
    void thread_grp_fu_82_p2();
    void thread_grp_turnCube_fu_60_ap_start();
    void thread_grp_turnCube_fu_60_turn_V();
