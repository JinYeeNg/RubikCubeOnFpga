...
HD_PWD='C:/Users/jinyee/RubikCube/Rubik_Cube_Layer_All/solution1/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log solveCube.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source solveCube.tcl -notrace
