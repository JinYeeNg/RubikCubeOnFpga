...
HD_PWD='C:/Users/jinyee/RubikCube/Rubik_Cube_Layer_All/solution1/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log solveCube.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source solveCube.tcl
