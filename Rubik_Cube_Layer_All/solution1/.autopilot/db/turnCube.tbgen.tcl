...
set C_modelName {turnCube}
set C_modelType { void 0 }
set C_modelArgList {
	{ turn_V int 4 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "turn_V", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "turn_V", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "turn_V", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "122", "Max" : "132"}
	, {"Name" : "Interval", "Min" : "122", "Max" : "132"}
]}
...
set Spec2ImplPortList { 
	turn_V { ap_none {  { turn_V in_data 0 4 } } }
