...
set C_modelArgMapList {[ 
	{ "Name" : "sCC_V", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "tCC_V", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sCC_V sc_in sc_lv 3 signal 0 } 
	{ tCC_V sc_in sc_lv 3 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sCC_V", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "sCC_V", "role": "default" }} , 
 	{ "name": "tCC_V", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "tCC_V", "role": "default" }} , 
...
set Spec2ImplPortList { 
	sCC_V { ap_none {  { sCC_V in_data 0 3 } } }
	tCC_V { ap_none {  { tCC_V in_data 0 3 } } }
