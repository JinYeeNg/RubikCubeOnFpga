...
int main(int argc, char **argv)
{
    ...
    // int a=check_cached_table("twistMove", (void*) twistMove2, sizeof(twistMove2), "caches");
    // a=check_cached_table("flipMove", (void*) flipMove2, sizeof(flipMove2), "caches");
    // a =check_cached_table("FRtoBR_Move", (void*) FRtoBR_Move2, sizeof(FRtoBR_Move2), "caches");
    // a=check_cached_table("URFtoDLF_Move", (void*) URFtoDLF_Move2, sizeof(URFtoDLF_Move2), "caches");
    // a=check_cached_table("URtoDF_Move", (void*) URtoDF_Move2, sizeof(URtoDF_Move2), "caches");
    // a=check_cached_table("URtoUL_Move", (void*) URtoUL_Move2, sizeof(URtoUL_Move2), "caches");
    // a=check_cached_table("UBtoDF_Move", (void*) UBtoDF_Move2, sizeof(UBtoDF_Move2), "caches");
    // a=check_cached_table("MergeURtoULandUBtoDF", (void*) MergeURtoULandUBtoDF2, sizeof(MergeURtoULandUBtoDF2), "caches");
    // a=check_cached_table("Slice_URFtoDLF_Parity_Prun", (void*) Slice_URFtoDLF_Parity_Prun2, sizeof(Slice_URFtoDLF_Parity_Prun2), "caches");
    // a=check_cached_table("Slice_URtoDF_Parity_Prun", (void*) Slice_URtoDF_Parity_Prun2, sizeof(Slice_URtoDF_Parity_Prun2), "caches");
    // a=check_cached_table("Slice_Twist_Prun", (void*) Slice_Twist_Prun2, sizeof(Slice_Twist_Prun2), "caches");
    // a=check_cached_table("Slice_Flip_Prun", (void*) Slice_Flip_Prun2, sizeof(Slice_Flip_Prun2), "caches");
