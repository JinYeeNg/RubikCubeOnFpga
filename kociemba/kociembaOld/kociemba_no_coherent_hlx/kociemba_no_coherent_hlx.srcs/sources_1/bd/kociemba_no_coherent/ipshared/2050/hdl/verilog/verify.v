...
wire   [63:0] tmp_i_29_fu_646_p1;
wire   [63:0] tmp_356_i_fu_718_p1;
wire   [63:0] tmp_i1_fu_763_p1;
wire   [63:0] tmp_361_i_fu_843_p1;
reg   [31:0] s_i_fu_88;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state32) & (tmp_360_i_fu_837_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state25) & (tmp_17_fu_625_p2 == 1'd1))) begin
        i_i_reg_346 <= 4'd11;
    end else if (((1'b1 == ap_CS_fsm_state28) & (tmp_355_i_fu_712_p2 == 1'd0))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state32)) begin
        cubiecube_0_cp_address0 = tmp_361_i_fu_843_p1;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state28)) begin
        cubiecube_0_ep_address0 = tmp_356_i_fu_718_p1;
    end else if ((1'b1 == ap_CS_fsm_state26)) begin
        cubiecube_0_ep_address0 = tmp_i_29_fu_646_p1;
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state28 : begin
            if (((1'b1 == ap_CS_fsm_state28) & (tmp_355_i_fu_712_p2 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_state26;
            end else begin
...
assign p_s_1_i1_fu_865_p3 = ((tmp_362_i_fu_854_p2[0:0] === 1'b1) ? s_1_fu_859_p2 : s_i8_fu_92);

assign p_s_1_i_fu_740_p3 = ((tmp_357_i_fu_729_p2[0:0] === 1'b1) ? s_fu_734_p2 : s_i_fu_88);
...
assign tmp_355_i_fu_712_p2 = (($signed(j_0_in_i_reg_358) > $signed(5'd0)) ? 1'b1 : 1'b0);

assign tmp_356_i_fu_718_p1 = $unsigned(j_cast_fu_708_p1);

assign tmp_357_i_fu_729_p2 = ((cubiecube_0_ep_q0 > cubiecube_0_ep_load_1_reg_1036) ? 1'b1 : 1'b0);

assign tmp_35_fu_792_p2 = (2'd0 - tmp_34_fu_784_p3);

assign tmp_360_i_fu_837_p2 = (($signed(j_0_in_i1_reg_379) > $signed(4'd0)) ? 1'b1 : 1'b0);

assign tmp_361_i_fu_843_p1 = $unsigned(j_1_cast_fu_833_p1);

assign tmp_362_i_fu_854_p2 = ((cubiecube_0_cp_q0 > cubiecube_0_cp_load_1_reg_1077) ? 1'b1 : 1'b0);
...
assign tmp_i_29_fu_646_p1 = i_i_reg_346;
