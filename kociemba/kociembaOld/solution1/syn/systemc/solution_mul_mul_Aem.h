...
#ifndef __solution_mul_mul_Aem__HH__
#define __solution_mul_mul_Aem__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(solution_mul_mul_Aem) {
    ...
    SC_CTOR(solution_mul_mul_Aem):  ACMP_smul_us_U ("ACMP_smul_us_U") {
