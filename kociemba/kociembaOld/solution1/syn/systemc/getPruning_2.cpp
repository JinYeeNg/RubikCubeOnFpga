...
const sc_lv<10> getPruning_2::ap_ST_fsm_state1 = "1";
const sc_lv<10> getPruning_2::ap_ST_fsm_state2 = "10";
const sc_lv<10> getPruning_2::ap_ST_fsm_state3 = "100";
const sc_lv<10> getPruning_2::ap_ST_fsm_state4 = "1000";
const sc_lv<10> getPruning_2::ap_ST_fsm_state5 = "10000";
const sc_lv<10> getPruning_2::ap_ST_fsm_state6 = "100000";
const sc_lv<10> getPruning_2::ap_ST_fsm_state7 = "1000000";
const sc_lv<10> getPruning_2::ap_ST_fsm_state8 = "10000000";
const sc_lv<10> getPruning_2::ap_ST_fsm_state9 = "100000000";
const sc_lv<10> getPruning_2::ap_ST_fsm_state10 = "1000000000";
...
const sc_lv<32> getPruning_2::ap_const_lv32_8 = "1000";
const sc_lv<32> getPruning_2::ap_const_lv32_18 = "11000";
const sc_lv<25> getPruning_2::ap_const_lv25_0 = "0000000000000000000000000";
...
getPruning_2::getPruning_2(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_311_reg_221 );
    sensitive << ( ap_CS_fsm_state10 );
    sensitive << ( tmp_299_fu_200_p4 );
    sensitive << ( tmp_315_fu_210_p1 );
    ...
    SC_METHOD(thread_tmp_20_fu_96_p4);
    sensitive << ( p_neg_fu_90_p2 );

    SC_METHOD(thread_tmp_21_fu_106_p1);
    sensitive << ( tmp_20_fu_96_p4 );

    SC_METHOD(thread_tmp_23_fu_120_p4);
    sensitive << ( index );

    SC_METHOD(thread_tmp_24_fu_130_p1);
    sensitive << ( tmp_23_fu_120_p4 );

    SC_METHOD(thread_tmp_292_fu_160_p1);
    sensitive << ( tmp_297_fu_156_p1 );

    SC_METHOD(thread_tmp_297_fu_156_p1);
    sensitive << ( tmp_fu_146_p4 );

    SC_METHOD(thread_tmp_298_fu_191_p1);
    sensitive << ( tmp_314_fu_184_p3 );

    SC_METHOD(thread_tmp_299_fu_200_p4);
    sensitive << ( table_load5_fu_195_p2 );

    SC_METHOD(thread_tmp_311_fu_78_p1);
    sensitive << ( index );

    SC_METHOD(thread_tmp_312_fu_82_p3);
    sensitive << ( index );

    SC_METHOD(thread_tmp_313_fu_164_p1);
    sensitive << ( tmp_s_fu_138_p3 );

    SC_METHOD(thread_tmp_314_fu_184_p3);
    sensitive << ( tmp_313_reg_226 );

    SC_METHOD(thread_tmp_315_fu_210_p1);
    sensitive << ( table_load5_fu_195_p2 );
    ...
    sc_trace(mVcdFile, tmp_311_fu_78_p1, "tmp_311_fu_78_p1");
    sc_trace(mVcdFile, tmp_311_reg_221, "tmp_311_reg_221");
    sc_trace(mVcdFile, tmp_313_fu_164_p1, "tmp_313_fu_164_p1");
    sc_trace(mVcdFile, tmp_313_reg_226, "tmp_313_reg_226");
    ...
    sc_trace(mVcdFile, tmp_20_fu_96_p4, "tmp_20_fu_96_p4");
    sc_trace(mVcdFile, tmp_21_fu_106_p1, "tmp_21_fu_106_p1");
    sc_trace(mVcdFile, p_lshr_fu_110_p1, "p_lshr_fu_110_p1");
    sc_trace(mVcdFile, tmp_23_fu_120_p4, "tmp_23_fu_120_p4");
    sc_trace(mVcdFile, tmp_24_fu_130_p1, "tmp_24_fu_130_p1");
    sc_trace(mVcdFile, tmp_312_fu_82_p3, "tmp_312_fu_82_p3");
    ...
    sc_trace(mVcdFile, tmp_297_fu_156_p1, "tmp_297_fu_156_p1");
    sc_trace(mVcdFile, tmp_292_fu_160_p1, "tmp_292_fu_160_p1");
    sc_trace(mVcdFile, sext_fu_168_p1, "sext_fu_168_p1");
    sc_trace(mVcdFile, ap_CS_fsm_state10, "ap_CS_fsm_state10");
    sc_trace(mVcdFile, tmp_314_fu_184_p3, "tmp_314_fu_184_p3");
    sc_trace(mVcdFile, tmp_298_fu_191_p1, "tmp_298_fu_191_p1");
    sc_trace(mVcdFile, table_load5_fu_195_p2, "table_load5_fu_195_p2");
    sc_trace(mVcdFile, tmp_299_fu_200_p4, "tmp_299_fu_200_p4");
    sc_trace(mVcdFile, tmp_315_fu_210_p1, "tmp_315_fu_210_p1");
...
void getPruning_2::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        ...
        tmp_311_reg_221 = tmp_311_fu_78_p1.read();
        tmp_313_reg_226 = tmp_313_fu_164_p1.read();
    }
}
...
void getPruning_2::thread_ap_CS_fsm_state9() {
...
void getPruning_2::thread_ap_return() {
    ap_return = (!tmp_311_reg_221.read()[0].is_01())? sc_lv<4>(): ((tmp_311_reg_221.read()[0].to_bool())? tmp_299_fu_200_p4.read(): tmp_315_fu_210_p1.read());
}
...
void getPruning_2::thread_p_lshr_f_fu_134_p1() {
    p_lshr_f_fu_134_p1 = esl_zext<32,31>(tmp_24_fu_130_p1.read());
}

void getPruning_2::thread_p_lshr_fu_110_p1() {
    p_lshr_fu_110_p1 = esl_zext<32,31>(tmp_21_fu_106_p1.read());
}

void getPruning_2::thread_p_neg_fu_90_p2() {
    p_neg_fu_90_p2 = (!ap_const_lv25_0.is_01() || !index.read().is_01())? sc_lv<25>(): (sc_biguint<25>(ap_const_lv25_0) - sc_biguint<25>(index.read()));
}

void getPruning_2::thread_p_neg_t_fu_114_p2() {
...
void getPruning_2::thread_sext_fu_168_p1() {
    sext_fu_168_p1 = esl_zext<64,31>(table_offset.read());
}

void getPruning_2::thread_sum_fu_172_p2() {
    sum_fu_172_p2 = (!tmp_292_fu_160_p1.read().is_01() || !sext_fu_168_p1.read().is_01())? sc_lv<64>(): (sc_biguint<64>(tmp_292_fu_160_p1.read()) + sc_biguint<64>(sext_fu_168_p1.read()));
}

void getPruning_2::thread_table_load5_fu_195_p2() {
    table_load5_fu_195_p2 = (!tmp_298_fu_191_p1.read().is_01())? sc_lv<16>(): table_addr_read_reg_237.read() >> (unsigned short)tmp_298_fu_191_p1.read().to_uint();
}
...
void getPruning_2::thread_tmp_20_fu_96_p4() {
    tmp_20_fu_96_p4 = p_neg_fu_90_p2.read().range(24, 1);
}

void getPruning_2::thread_tmp_21_fu_106_p1() {
    tmp_21_fu_106_p1 = esl_sext<31,24>(tmp_20_fu_96_p4.read());
}

void getPruning_2::thread_tmp_23_fu_120_p4() {
    tmp_23_fu_120_p4 = index.read().range(24, 1);
}

void getPruning_2::thread_tmp_24_fu_130_p1() {
    tmp_24_fu_130_p1 = esl_sext<31,24>(tmp_23_fu_120_p4.read());
}

void getPruning_2::thread_tmp_292_fu_160_p1() {
    tmp_292_fu_160_p1 = esl_zext<64,63>(tmp_297_fu_156_p1.read());
}

void getPruning_2::thread_tmp_297_fu_156_p1() {
    tmp_297_fu_156_p1 = esl_sext<63,31>(tmp_fu_146_p4.read());
}

void getPruning_2::thread_tmp_298_fu_191_p1() {
    tmp_298_fu_191_p1 = esl_zext<16,4>(tmp_314_fu_184_p3.read());
}

void getPruning_2::thread_tmp_299_fu_200_p4() {
    tmp_299_fu_200_p4 = table_load5_fu_195_p2.read().range(7, 4);
}

void getPruning_2::thread_tmp_311_fu_78_p1() {
    tmp_311_fu_78_p1 = index.read().range(1-1, 0);
}

void getPruning_2::thread_tmp_312_fu_82_p3() {
    tmp_312_fu_82_p3 = index.read().range(24, 24);
}

void getPruning_2::thread_tmp_313_fu_164_p1() {
    tmp_313_fu_164_p1 = tmp_s_fu_138_p3.read().range(1-1, 0);
}

void getPruning_2::thread_tmp_314_fu_184_p3() {
    tmp_314_fu_184_p3 = esl_concat<1,3>(tmp_313_reg_226.read(), ap_const_lv3_0);
}

void getPruning_2::thread_tmp_315_fu_210_p1() {
    tmp_315_fu_210_p1 = table_load5_fu_195_p2.read().range(4-1, 0);
}

void getPruning_2::thread_tmp_fu_146_p4() {
    tmp_fu_146_p4 = tmp_s_fu_138_p3.read().range(31, 1);
}

void getPruning_2::thread_tmp_s_fu_138_p3() {
    tmp_s_fu_138_p3 = (!tmp_312_fu_82_p3.read()[0].is_01())? sc_lv<32>(): ((tmp_312_fu_82_p3.read()[0].to_bool())? p_neg_t_fu_114_p2.read(): p_lshr_f_fu_134_p1.read());
}
