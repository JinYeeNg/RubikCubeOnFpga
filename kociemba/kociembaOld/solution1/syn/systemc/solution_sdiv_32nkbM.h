...
#ifndef __solution_sdiv_32nkbM__HH__
#define __solution_sdiv_32nkbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(solution_sdiv_32nkbM) {
    ...
    SC_CTOR(solution_sdiv_32nkbM):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
