...
#ifndef __solution_urem_5nsibs__HH__
#define __solution_urem_5nsibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(solution_urem_5nsibs) {
    ...
    SC_CTOR(solution_urem_5nsibs):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
