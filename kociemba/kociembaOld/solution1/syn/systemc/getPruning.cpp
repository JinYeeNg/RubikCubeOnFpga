...
const sc_lv<10> getPruning::ap_ST_fsm_state1 = "1";
const sc_lv<10> getPruning::ap_ST_fsm_state2 = "10";
const sc_lv<10> getPruning::ap_ST_fsm_state3 = "100";
const sc_lv<10> getPruning::ap_ST_fsm_state4 = "1000";
const sc_lv<10> getPruning::ap_ST_fsm_state5 = "10000";
const sc_lv<10> getPruning::ap_ST_fsm_state6 = "100000";
const sc_lv<10> getPruning::ap_ST_fsm_state7 = "1000000";
const sc_lv<10> getPruning::ap_ST_fsm_state8 = "10000000";
const sc_lv<10> getPruning::ap_ST_fsm_state9 = "100000000";
const sc_lv<10> getPruning::ap_ST_fsm_state10 = "1000000000";
...
const sc_lv<32> getPruning::ap_const_lv32_8 = "1000";
...
getPruning::getPruning(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_321_reg_207 );
    sensitive << ( ap_CS_fsm_state10 );
    sensitive << ( tmp_307_fu_186_p4 );
    sensitive << ( tmp_327_fu_196_p1 );
    ...
    SC_METHOD(thread_tmp_298_fu_146_p1);
    sensitive << ( tmp_305_fu_142_p1 );

    SC_METHOD(thread_tmp_303_fu_120_p1);
    sensitive << ( p_lshr_f_fu_110_p4 );

    SC_METHOD(thread_tmp_304_fu_132_p4);
    sensitive << ( tmp_s_fu_124_p3 );

    SC_METHOD(thread_tmp_305_fu_142_p1);
    sensitive << ( tmp_304_fu_132_p4 );

    SC_METHOD(thread_tmp_306_fu_177_p1);
    sensitive << ( tmp_326_fu_170_p3 );

    SC_METHOD(thread_tmp_307_fu_186_p4);
    sensitive << ( table_load5_fu_181_p2 );

    SC_METHOD(thread_tmp_321_fu_72_p1);
    sensitive << ( index );

    SC_METHOD(thread_tmp_324_fu_76_p3);
    sensitive << ( index );

    SC_METHOD(thread_tmp_325_fu_150_p1);
    sensitive << ( tmp_s_fu_124_p3 );

    SC_METHOD(thread_tmp_326_fu_170_p3);
    sensitive << ( tmp_325_reg_212 );

    SC_METHOD(thread_tmp_327_fu_196_p1);
    sensitive << ( table_load5_fu_181_p2 );
    ...
    sensitive << ( tmp_324_fu_76_p3 );
    sensitive << ( p_neg_t_fu_104_p2 );
    sensitive << ( tmp_303_fu_120_p1 );
    ...
    sc_trace(mVcdFile, tmp_321_fu_72_p1, "tmp_321_fu_72_p1");
    sc_trace(mVcdFile, tmp_321_reg_207, "tmp_321_reg_207");
    sc_trace(mVcdFile, tmp_325_fu_150_p1, "tmp_325_fu_150_p1");
    sc_trace(mVcdFile, tmp_325_reg_212, "tmp_325_reg_212");
    ...
    sc_trace(mVcdFile, tmp_324_fu_76_p3, "tmp_324_fu_76_p3");
    sc_trace(mVcdFile, p_neg_t_fu_104_p2, "p_neg_t_fu_104_p2");
    sc_trace(mVcdFile, tmp_303_fu_120_p1, "tmp_303_fu_120_p1");
    sc_trace(mVcdFile, tmp_s_fu_124_p3, "tmp_s_fu_124_p3");
    sc_trace(mVcdFile, tmp_304_fu_132_p4, "tmp_304_fu_132_p4");
    sc_trace(mVcdFile, tmp_305_fu_142_p1, "tmp_305_fu_142_p1");
    sc_trace(mVcdFile, tmp_298_fu_146_p1, "tmp_298_fu_146_p1");
    sc_trace(mVcdFile, sext_fu_154_p1, "sext_fu_154_p1");
    sc_trace(mVcdFile, ap_CS_fsm_state10, "ap_CS_fsm_state10");
    sc_trace(mVcdFile, tmp_326_fu_170_p3, "tmp_326_fu_170_p3");
    sc_trace(mVcdFile, tmp_306_fu_177_p1, "tmp_306_fu_177_p1");
    sc_trace(mVcdFile, table_load5_fu_181_p2, "table_load5_fu_181_p2");
    sc_trace(mVcdFile, tmp_307_fu_186_p4, "tmp_307_fu_186_p4");
    sc_trace(mVcdFile, tmp_327_fu_196_p1, "tmp_327_fu_196_p1");
...
void getPruning::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        ...
        tmp_321_reg_207 = tmp_321_fu_72_p1.read();
        tmp_325_reg_212 = tmp_325_fu_150_p1.read();
    }
}
...
void getPruning::thread_ap_CS_fsm_state9() {
...
void getPruning::thread_ap_return() {
    ap_return = (!tmp_321_reg_207.read()[0].is_01())? sc_lv<4>(): ((tmp_321_reg_207.read()[0].to_bool())? tmp_307_fu_186_p4.read(): tmp_327_fu_196_p1.read());
}
...
void getPruning::thread_sext_fu_154_p1() {
    sext_fu_154_p1 = esl_zext<64,31>(table_offset.read());
}

void getPruning::thread_sum_fu_158_p2() {
    sum_fu_158_p2 = (!tmp_298_fu_146_p1.read().is_01() || !sext_fu_154_p1.read().is_01())? sc_lv<64>(): (sc_biguint<64>(tmp_298_fu_146_p1.read()) + sc_biguint<64>(sext_fu_154_p1.read()));
}

void getPruning::thread_table_load5_fu_181_p2() {
    table_load5_fu_181_p2 = (!tmp_306_fu_177_p1.read().is_01())? sc_lv<16>(): table_addr_read_reg_223.read() >> (unsigned short)tmp_306_fu_177_p1.read().to_uint();
}
...
void getPruning::thread_tmp_298_fu_146_p1() {
    tmp_298_fu_146_p1 = esl_zext<64,63>(tmp_305_fu_142_p1.read());
}

void getPruning::thread_tmp_303_fu_120_p1() {
    tmp_303_fu_120_p1 = esl_zext<32,31>(p_lshr_f_fu_110_p4.read());
}

void getPruning::thread_tmp_304_fu_132_p4() {
    tmp_304_fu_132_p4 = tmp_s_fu_124_p3.read().range(31, 1);
}

void getPruning::thread_tmp_305_fu_142_p1() {
    tmp_305_fu_142_p1 = esl_sext<63,31>(tmp_304_fu_132_p4.read());
}

void getPruning::thread_tmp_306_fu_177_p1() {
    tmp_306_fu_177_p1 = esl_zext<16,4>(tmp_326_fu_170_p3.read());
}

void getPruning::thread_tmp_307_fu_186_p4() {
    tmp_307_fu_186_p4 = table_load5_fu_181_p2.read().range(7, 4);
}

void getPruning::thread_tmp_321_fu_72_p1() {
    tmp_321_fu_72_p1 = index.read().range(1-1, 0);
}

void getPruning::thread_tmp_324_fu_76_p3() {
    tmp_324_fu_76_p3 = index.read().range(31, 31);
}

void getPruning::thread_tmp_325_fu_150_p1() {
    tmp_325_fu_150_p1 = tmp_s_fu_124_p3.read().range(1-1, 0);
}

void getPruning::thread_tmp_326_fu_170_p3() {
    tmp_326_fu_170_p3 = esl_concat<1,3>(tmp_325_reg_212.read(), ap_const_lv3_0);
}

void getPruning::thread_tmp_327_fu_196_p1() {
    tmp_327_fu_196_p1 = table_load5_fu_181_p2.read().range(4-1, 0);
}

void getPruning::thread_tmp_fu_100_p1() {
    tmp_fu_100_p1 = esl_zext<32,31>(p_lshr_fu_90_p4.read());
}

void getPruning::thread_tmp_s_fu_124_p3() {
    tmp_s_fu_124_p3 = (!tmp_324_fu_76_p3.read()[0].is_01())? sc_lv<32>(): ((tmp_324_fu_76_p3.read()[0].to_bool())? p_neg_t_fu_104_p2.read(): tmp_303_fu_120_p1.read());
}
