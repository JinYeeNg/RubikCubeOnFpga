...
#ifndef __solution_mac_mulaCeG__HH__
#define __solution_mac_mulaCeG__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(solution_mac_mulaCeG) {
    ...
    SC_CTOR(solution_mac_mulaCeG):  simcore_mac_1_U ("simcore_mac_1_U") {
