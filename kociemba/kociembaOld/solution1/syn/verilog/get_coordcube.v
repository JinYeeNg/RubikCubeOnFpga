...
wire   [3:0] i_17_fu_273_p2;
reg   [3:0] i_17_reg_469;
wire    ap_CS_fsm_state4;
wire   [0:0] exitcond_i3_fu_267_p2;
wire   [14:0] tmp_256_fu_284_p1;
reg   [14:0] tmp_256_reg_479;
...
wire   [0:0] tmp_360_i_fu_331_p2;
wire   [2:0] i_18_fu_342_p2;
...
wire   [63:0] tmp_i_46_fu_234_p1;
wire   [63:0] tmp_i5_fu_279_p1;
wire   [63:0] tmp_i8_fu_316_p1;
wire   [63:0] tmp_361_i_fu_337_p1;
reg   [31:0] s_i_fu_72;
wire   [31:0] p_s_1_i_fu_359_p3;
reg    ap_block_state10_on_subcall_done;
wire   [15:0] tmp_fu_245_p2;
wire   [15:0] tmp_331_i_fu_257_p1;
wire   [15:0] tmp_i_fu_251_p2;
wire  signed [31:0] j_cast_fu_327_p1;
wire   [0:0] tmp_362_i_fu_348_p2;
wire   [31:0] s_fu_353_p2;
wire   [0:0] tmp_259_fu_408_p1;
wire   [15:0] tmp_260_fu_412_p3;
wire   [0:0] tmp_258_fu_404_p1;
wire   [0:0] tmp_257_fu_396_p3;
wire   [15:0] tmp_261_fu_420_p2;
wire   [15:0] tmp_254_fu_426_p3;
reg   [15:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((tmp_360_i_fu_331_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        cubiecube_0_cp_address0 = tmp_361_i_fu_337_p1;
...
assign cubiecube_0_co_address0 = tmp_i_46_fu_234_p1;
...
assign i_17_fu_273_p2 = (i_i1_reg_146 + 4'd1);

assign i_18_fu_342_p2 = ($signed(i_i6_reg_168) + $signed(3'd7));
...
assign p_s_1_i_fu_359_p3 = ((tmp_362_i_fu_348_p2[0:0] === 1'b1) ? s_fu_353_p2 : s_i_fu_72);
...
assign result_parity_0 = ((tmp_257_fu_396_p3[0:0] === 1'b1) ? tmp_261_fu_420_p2 : tmp_254_fu_426_p3);

assign result_twist_0 = ret_i_reg_123;

assign ret_1_fu_299_p3 = {{tmp_256_reg_479}, {cubiecube_0_eo_q0}};

assign ret_fu_261_p2 = (tmp_331_i_fu_257_p1 + tmp_i_fu_251_p2);

assign s_fu_353_p2 = (s_i_fu_72 + 32'd1);

assign tmp_254_fu_426_p3 = {{15'd0}, {tmp_258_fu_404_p1}};

assign tmp_256_fu_284_p1 = ret_i2_reg_157[14:0];

assign tmp_257_fu_396_p3 = s_i_fu_72[32'd31];

assign tmp_258_fu_404_p1 = s_i_fu_72[0:0];

assign tmp_259_fu_408_p1 = s_i_fu_72[0:0];

assign tmp_260_fu_412_p3 = {{15'd0}, {tmp_259_fu_408_p1}};

assign tmp_261_fu_420_p2 = (16'd0 - tmp_260_fu_412_p3);

assign tmp_331_i_fu_257_p1 = cubiecube_0_co_q0;

assign tmp_360_i_fu_331_p2 = (($signed(j_0_in_i_reg_180) > $signed(4'd0)) ? 1'b1 : 1'b0);

assign tmp_361_i_fu_337_p1 = $unsigned(j_cast_fu_327_p1);

assign tmp_362_i_fu_348_p2 = ((cubiecube_0_cp_q0 > cubiecube_0_cp_load_reg_509) ? 1'b1 : 1'b0);
...
assign tmp_i_46_fu_234_p1 = i_i_reg_135;
