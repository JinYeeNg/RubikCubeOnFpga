...
wire   [0:0] tmp_293_fu_78_p1;
reg   [0:0] tmp_293_reg_221;
wire   [0:0] tmp_299_fu_164_p1;
reg   [0:0] tmp_299_reg_226;
reg   [31:0] table_addr_reg_231;
reg   [15:0] table_addr_read_reg_237;
wire   [63:0] sum_fu_172_p2;
reg    ap_reg_ioackin_m_axi_table_r_ARREADY;
reg    ap_sig_ioackin_m_axi_table_r_ARREADY;
wire   [23:0] p_neg_fu_90_p2;
wire   [22:0] tmp_297_fu_96_p4;
wire  signed [30:0] p_lshr_fu_106_p1;
wire   [31:0] tmp_fu_110_p1;
wire   [22:0] tmp_298_fu_120_p4;
wire  signed [30:0] p_lshr_f_fu_130_p1;
wire   [0:0] tmp_296_fu_82_p3;
wire   [31:0] p_neg_t_fu_114_p2;
wire   [31:0] tmp_287_fu_134_p1;
wire   [31:0] tmp_s_fu_138_p3;
wire   [30:0] tmp_288_fu_146_p4;
wire  signed [62:0] tmp_289_fu_156_p1;
wire   [63:0] tmp_286_fu_160_p1;
wire   [63:0] sext_fu_168_p1;
wire    ap_CS_fsm_state10;
wire   [3:0] tmp_300_fu_184_p3;
wire   [15:0] tmp_290_fu_191_p1;
wire   [15:0] table_load5_fu_195_p2;
wire   [3:0] tmp_291_fu_200_p4;
wire   [3:0] tmp_301_fu_210_p1;
reg   [9:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((m_axi_table_r_RVALID == 1'b1) & (1'b1 == ap_CS_fsm_state9))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        table_addr_reg_231 <= sum_fu_172_p2;
...
always @ (*) begin
    if (((ap_reg_ioackin_m_axi_table_r_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (ap_sig_ioackin_m_axi_table_r_ARREADY == 1'b1))) begin
...
assign ap_return = ((tmp_293_reg_221[0:0] === 1'b1) ? tmp_291_fu_200_p4 : tmp_301_fu_210_p1);

assign m_axi_table_r_ARADDR = table_addr_reg_231;
...
assign p_lshr_f_fu_130_p1 = $signed(tmp_298_fu_120_p4);

assign p_lshr_fu_106_p1 = $signed(tmp_297_fu_96_p4);

assign p_neg_fu_90_p2 = (24'd0 - index);

assign p_neg_t_fu_114_p2 = (32'd0 - tmp_fu_110_p1);

assign sext_fu_168_p1 = table_offset;

assign sum_fu_172_p2 = (tmp_286_fu_160_p1 + sext_fu_168_p1);

assign table_load5_fu_195_p2 = table_addr_read_reg_237 >> tmp_290_fu_191_p1;

assign tmp_286_fu_160_p1 = $unsigned(tmp_289_fu_156_p1);

assign tmp_287_fu_134_p1 = $unsigned(p_lshr_f_fu_130_p1);

assign tmp_288_fu_146_p4 = {{tmp_s_fu_138_p3[31:1]}};

assign tmp_289_fu_156_p1 = $signed(tmp_288_fu_146_p4);

assign tmp_290_fu_191_p1 = tmp_300_fu_184_p3;

assign tmp_291_fu_200_p4 = {{table_load5_fu_195_p2[7:4]}};

assign tmp_293_fu_78_p1 = index[0:0];

assign tmp_296_fu_82_p3 = index[32'd23];

assign tmp_297_fu_96_p4 = {{p_neg_fu_90_p2[23:1]}};

assign tmp_298_fu_120_p4 = {{index[23:1]}};

assign tmp_299_fu_164_p1 = tmp_s_fu_138_p3[0:0];

assign tmp_300_fu_184_p3 = {{tmp_299_reg_226}, {3'd0}};

assign tmp_301_fu_210_p1 = table_load5_fu_195_p2[3:0];

assign tmp_fu_110_p1 = $unsigned(p_lshr_fu_106_p1);

assign tmp_s_fu_138_p3 = ((tmp_296_fu_82_p3[0:0] === 1'b1) ? p_neg_t_fu_114_p2 : tmp_287_fu_134_p1);

endmodule //getPruning1314
