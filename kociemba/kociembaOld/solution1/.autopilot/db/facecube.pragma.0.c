# 1 "kociemba/facecube.c"
# 1 "kociemba/facecube.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 4 "kociemba/facecube.c" 2
# 1 "kociemba/cubiecube.h" 1
# 11 "kociemba/cubiecube.h"
struct cubiecube {
