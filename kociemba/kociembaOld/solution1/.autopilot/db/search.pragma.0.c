...
#pragma HLS INTERFACE m_axi depth=39366 port=&twistMove2 offset=slave bundle=CTRL_BUS
#pragma HLS INTERFACE m_axi depth=36864 port=&flipMove2 offset=slave bundle=CTRL_BUS
#pragma HLS INTERFACE m_axi depth=213840 port=&FRtoBR_Move2 offset=slave bundle=CTRL_BUS
#pragma HLS INTERFACE m_axi depth=362880 port=&URFtoDLF_Move2 offset=slave bundle=CTRL_BUS
#pragma HLS INTERFACE m_axi depth=362880 port=&URtoDF_Move2 offset=slave bundle=CTRL_BUS
#pragma HLS INTERFACE m_axi depth=23760 port=&URtoUL_Move2 offset=slave bundle=CTRL_BUS
#pragma HLS INTERFACE m_axi depth=23760 port=&UBtoDF_Move2 offset=slave bundle=CTRL_BUS
#pragma HLS INTERFACE m_axi depth=112896 port=&MergeURtoULandUBtoDF2 offset=slave bundle=CTRL_BUS
#pragma HLS INTERFACE m_axi depth=483840 port=&Slice_URFtoDLF_Parity_Prun2 offset=slave bundle=CTRL_BUS
#pragma HLS INTERFACE m_axi depth=483840 port=&Slice_URtoDF_Parity_Prun2 offset=slave bundle=CTRL_BUS
#pragma HLS INTERFACE m_axi depth=541283 port=&Slice_Twist_Prun2 offset=slave bundle=CTRL_BUS
#pragma HLS INTERFACE m_axi depth=506880 port=&Slice_Flip_Prun2 offset=slave bundle=CTRL_BUS
