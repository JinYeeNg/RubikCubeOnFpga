...
wire   [0:0] tmp_284_fu_72_p1;
reg   [0:0] tmp_284_reg_207;
wire   [0:0] tmp_288_fu_150_p1;
reg   [0:0] tmp_288_reg_212;
reg   [31:0] table_addr_reg_217;
reg   [15:0] table_addr_read_reg_223;
wire   [63:0] sum_fu_158_p2;
reg    ap_reg_ioackin_m_axi_table_r_ARREADY;
reg    ap_sig_ioackin_m_axi_table_r_ARREADY;
wire   [31:0] p_neg_fu_84_p2;
wire   [30:0] p_lshr_fu_90_p4;
wire   [31:0] tmp_fu_100_p1;
wire   [30:0] p_lshr_f_fu_110_p4;
wire   [0:0] tmp_285_fu_76_p3;
wire   [31:0] p_neg_t_fu_104_p2;
wire   [31:0] tmp_279_fu_120_p1;
wire   [31:0] tmp_s_fu_124_p3;
wire   [30:0] tmp_281_fu_132_p4;
wire  signed [62:0] tmp_282_fu_142_p1;
wire   [63:0] tmp_280_fu_146_p1;
wire   [63:0] sext_fu_154_p1;
wire    ap_CS_fsm_state10;
wire   [3:0] tmp_289_fu_170_p3;
wire   [15:0] tmp_283_fu_177_p1;
wire   [15:0] table_load5_fu_181_p2;
wire   [3:0] tmp_286_fu_186_p4;
wire   [3:0] tmp_290_fu_196_p1;
reg   [9:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        table_addr_reg_217 <= sum_fu_158_p2;
...
assign ap_return = ((tmp_284_reg_207[0:0] === 1'b1) ? tmp_286_fu_186_p4 : tmp_290_fu_196_p1);

assign m_axi_table_r_ARADDR = table_addr_reg_217;
...
assign p_lshr_f_fu_110_p4 = {{index[31:1]}};

assign p_lshr_fu_90_p4 = {{p_neg_fu_84_p2[31:1]}};

assign p_neg_fu_84_p2 = (32'd0 - index);

assign p_neg_t_fu_104_p2 = (32'd0 - tmp_fu_100_p1);

assign sext_fu_154_p1 = table_offset;

assign sum_fu_158_p2 = (tmp_280_fu_146_p1 + sext_fu_154_p1);

assign table_load5_fu_181_p2 = table_addr_read_reg_223 >> tmp_283_fu_177_p1;

assign tmp_279_fu_120_p1 = p_lshr_f_fu_110_p4;

assign tmp_280_fu_146_p1 = $unsigned(tmp_282_fu_142_p1);

assign tmp_281_fu_132_p4 = {{tmp_s_fu_124_p3[31:1]}};

assign tmp_282_fu_142_p1 = $signed(tmp_281_fu_132_p4);

assign tmp_283_fu_177_p1 = tmp_289_fu_170_p3;

assign tmp_284_fu_72_p1 = index[0:0];

assign tmp_285_fu_76_p3 = index[32'd31];

assign tmp_286_fu_186_p4 = {{table_load5_fu_181_p2[7:4]}};

assign tmp_288_fu_150_p1 = tmp_s_fu_124_p3[0:0];

assign tmp_289_fu_170_p3 = {{tmp_288_reg_212}, {3'd0}};

assign tmp_290_fu_196_p1 = table_load5_fu_181_p2[3:0];

assign tmp_fu_100_p1 = p_lshr_fu_90_p4;

assign tmp_s_fu_124_p3 = ((tmp_285_fu_76_p3[0:0] === 1'b1) ? p_neg_t_fu_104_p2 : tmp_279_fu_120_p1);

endmodule //getPruning131416
