...
set IPName      "solution"
set Version     "1.0"
set DisplayName "Solution"
set Revision    "1907040209"
...
set Interfaces {
    s_axi_CTRL_BUS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x80 maxDepth W 0x0 "Data signal of maxDepth" {{0 8 maxDepth W 0 "Bit 7 to 0 Data signal of maxDepth"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x88 unsolvable R 0x0 "Data signal of unsolvable" {{0 1 unsolvable R 0 "Bit 0 to 0 Data signal of unsolvable"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x8c unsolvable_ctrl R 0x0 "Control signal of unsolvable" {{0 1 unsolvable_ap_vld R 0 "Control signal unsolvable_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x90 encode_length R 0x0 "Data signal of encode_length" {{0 8 encode_length R 0 "Bit 7 to 0 Data signal of encode_length"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x94 encode_length_ctrl R 0x0 "Control signal of encode_length" {{0 1 encode_length_ap_vld R 0 "Control signal encode_length_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x10 twistMove2 W 0x0 "Data signal of twistMove2" {{0 32 twistMove2 W 0 "Bit 31 to 0 Data signal of twistMove2"}}} {0x18 flipMove2 W 0x0 "Data signal of flipMove2" {{0 32 flipMove2 W 0 "Bit 31 to 0 Data signal of flipMove2"}}} {0x20 FRtoBR_Move2 W 0x0 "Data signal of FRtoBR_Move2" {{0 32 FRtoBR_Move2 W 0 "Bit 31 to 0 Data signal of FRtoBR_Move2"}}} {0x28 URFtoDLF_Move2 W 0x0 "Data signal of URFtoDLF_Move2" {{0 32 URFtoDLF_Move2 W 0 "Bit 31 to 0 Data signal of URFtoDLF_Move2"}}} {0x30 URtoDF_Move2 W 0x0 "Data signal of URtoDF_Move2" {{0 32 URtoDF_Move2 W 0 "Bit 31 to 0 Data signal of URtoDF_Move2"}}} {0x38 URtoUL_Move2 W 0x0 "Data signal of URtoUL_Move2" {{0 32 URtoUL_Move2 W 0 "Bit 31 to 0 Data signal of URtoUL_Move2"}}} {0x98 UBtoDF_Move2 W 0x0 "Data signal of UBtoDF_Move2" {{0 32 UBtoDF_Move2 W 0 "Bit 31 to 0 Data signal of UBtoDF_Move2"}}} {0xc0 MergeURtoULandUBtoDF2 W 0x0 "Data signal of MergeURtoULandUBtoDF2" {{0 32 MergeURtoULandUBtoDF2 W 0 "Bit 31 to 0 Data signal of MergeURtoULandUBtoDF2"}}} {0xc8 Slice_URFtoDLF_Parity_Prun2 W 0x0 "Data signal of Slice_URFtoDLF_Parity_Prun2" {{0 32 Slice_URFtoDLF_Parity_Prun2 W 0 "Bit 31 to 0 Data signal of Slice_URFtoDLF_Parity_Prun2"}}} {0xd0 Slice_URtoDF_Parity_Prun2 W 0x0 "Data signal of Slice_URtoDF_Parity_Prun2" {{0 32 Slice_URtoDF_Parity_Prun2 W 0 "Bit 31 to 0 Data signal of Slice_URtoDF_Parity_Prun2"}}} {0xd8 Slice_Twist_Prun2 W 0x0 "Data signal of Slice_Twist_Prun2" {{0 32 Slice_Twist_Prun2 W 0 "Bit 31 to 0 Data signal of Slice_Twist_Prun2"}}} {0xe0 Slice_Flip_Prun2 W 0x0 "Data signal of Slice_Flip_Prun2" {{0 32 Slice_Flip_Prun2 W 0 "Bit 31 to 0 Data signal of Slice_Flip_Prun2"}}}}
        memories "facelets {base_address 64 range 64} encode_array {base_address 160 range 32}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL_BUS m_axi_CTRL_BUS1 m_axi_CTRL_BUS2 m_axi_CTRL_BUS3"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_CTRL_BUS1 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_CTRL_BUS1"
        data_width "32"
        param_prefix "C_M_AXI_CTRL_BUS1"
    ...
    m_axi_CTRL_BUS2 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_CTRL_BUS2"
        data_width "32"
        param_prefix "C_M_AXI_CTRL_BUS2"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_CTRL_BUS3 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_CTRL_BUS3"
        data_width "32"
        param_prefix "C_M_AXI_CTRL_BUS3"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
