...
architecture behav of getPruning_228 is 
    ...
    signal tmp_127_fu_82_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_127_reg_228 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_188_reg_233 : STD_LOGIC_VECTOR (30 downto 0);
    signal tmp_131_fu_164_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_131_reg_238 : STD_LOGIC_VECTOR (0 downto 0);
    signal table_addr_reg_243 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal table_addr_read_reg_249 : STD_LOGIC_VECTOR (15 downto 0);
    signal sum_fu_179_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_reg_ioackin_m_axi_table_r_ARREADY : STD_LOGIC := '0';
    signal ap_sig_ioackin_m_axi_table_r_ARREADY : STD_LOGIC;
    signal tmp_127_fu_82_p0 : STD_LOGIC_VECTOR (22 downto 0);
    signal tmp_128_fu_86_p1 : STD_LOGIC_VECTOR (22 downto 0);
    signal index_cast4_fu_94_p0 : STD_LOGIC_VECTOR (22 downto 0);
    signal index_cast4_fu_94_p1 : STD_LOGIC_VECTOR (23 downto 0);
    signal p_neg_fu_98_p2 : STD_LOGIC_VECTOR (23 downto 0);
    signal tmp_129_fu_104_p4 : STD_LOGIC_VECTOR (22 downto 0);
    signal p_lshr_fu_114_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal tmp_fu_118_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_130_fu_128_p1 : STD_LOGIC_VECTOR (22 downto 0);
    signal tmp_130_fu_128_p4 : STD_LOGIC_VECTOR (21 downto 0);
    signal p_lshr_f_fu_138_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal tmp_128_fu_86_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_neg_t_fu_122_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_187_fu_142_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_s_fu_146_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_189_fu_168_p1 : STD_LOGIC_VECTOR (62 downto 0);
    signal tmp_193_fu_171_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_fu_175_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_CS_fsm_state11 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state11 : signal is "none";
    signal tmp_132_fu_191_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_191_fu_198_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal table_load5_fu_202_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_192_fu_207_p4 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_133_fu_217_p1 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((m_axi_table_r_RVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state10))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                table_addr_reg_243 <= sum_fu_179_p2(32 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then
                ...
                tmp_188_reg_233 <= tmp_s_fu_146_p3(31 downto 1);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, m_axi_table_r_RVALID, ap_CS_fsm_state3, ap_CS_fsm_state10, ap_sig_ioackin_m_axi_table_r_ARREADY)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state3) and (ap_sig_ioackin_m_axi_table_r_ARREADY = ap_const_logic_1))) then
    ...
    ap_return <= 
        tmp_192_fu_207_p4 when (tmp_127_reg_228(0) = '1') else 
        tmp_133_fu_217_p1;
    ...
    index_cast4_fu_94_p0 <= index;
        index_cast4_fu_94_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(index_cast4_fu_94_p0),24));

    m_axi_table_r_ARADDR <= table_addr_reg_243;
    ...
    m_axi_table_r_ARVALID_assign_proc : process(ap_CS_fsm_state3, ap_reg_ioackin_m_axi_table_r_ARREADY)
    begin
        if (((ap_reg_ioackin_m_axi_table_r_ARREADY = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    m_axi_table_r_RREADY_assign_proc : process(m_axi_table_r_RVALID, ap_CS_fsm_state10)
    begin
        if (((m_axi_table_r_RVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state10))) then 
    ...
    m_axi_table_r_WVALID <= ap_const_logic_0;
        p_lshr_f_fu_138_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_130_fu_128_p4),31));

        p_lshr_fu_114_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_129_fu_104_p4),31));

    p_neg_fu_98_p2 <= std_logic_vector(unsigned(ap_const_lv24_0) - unsigned(index_cast4_fu_94_p1));
    p_neg_t_fu_122_p2 <= std_logic_vector(unsigned(ap_const_lv32_0) - unsigned(tmp_fu_118_p1));
    sext_fu_175_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(table_offset),64));
    sum_fu_179_p2 <= std_logic_vector(unsigned(tmp_193_fu_171_p1) + unsigned(sext_fu_175_p1));
    table_load5_fu_202_p2 <= std_logic_vector(shift_right(unsigned(table_addr_read_reg_249),to_integer(unsigned('0' & tmp_191_fu_198_p1(16-1 downto 0)))));

    table_r_blk_n_AR_assign_proc : process(m_axi_table_r_ARREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
    ...
    table_r_blk_n_R_assign_proc : process(m_axi_table_r_RVALID, ap_CS_fsm_state10)
    begin
    ...
    tmp_127_fu_82_p0 <= index;
    tmp_127_fu_82_p1 <= tmp_127_fu_82_p0(1 - 1 downto 0);
    tmp_128_fu_86_p1 <= index;
    tmp_128_fu_86_p3 <= tmp_128_fu_86_p1(22 downto 22);
    tmp_129_fu_104_p4 <= p_neg_fu_98_p2(23 downto 1);
    tmp_130_fu_128_p1 <= index;
    tmp_130_fu_128_p4 <= tmp_130_fu_128_p1(22 downto 1);
    tmp_131_fu_164_p1 <= tmp_s_fu_146_p3(1 - 1 downto 0);
    tmp_132_fu_191_p3 <= (tmp_131_reg_238 & ap_const_lv3_0);
    tmp_133_fu_217_p1 <= table_load5_fu_202_p2(4 - 1 downto 0);
    tmp_187_fu_142_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_lshr_f_fu_138_p1),32));
        tmp_189_fu_168_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_188_reg_233),63));

    tmp_191_fu_198_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_132_fu_191_p3),16));
    tmp_192_fu_207_p4 <= table_load5_fu_202_p2(7 downto 4);
    tmp_193_fu_171_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_189_fu_168_p1),64));
    tmp_fu_118_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_lshr_fu_114_p1),32));
    tmp_s_fu_146_p3 <= 
        p_neg_t_fu_122_p2 when (tmp_128_fu_86_p3(0) = '1') else 
        tmp_187_fu_142_p1;
end behav;
