# 1 "/home/jinyeeng/Downloads/RubikCube-af660b02594911b39652037663f50280ce7ec755/kociemba/kociembaHls/solution1/.autopilot/db/prunetable_helpers.pragma.1.cpp"
# 1 "/home/jinyeeng/Downloads/RubikCube-af660b02594911b39652037663f50280ce7ec755/kociemba/kociembaHls/solution1/.autopilot/db/prunetable_helpers.pragma.1.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 155 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "/home/jinyeeng/Downloads/RubikCube-af660b02594911b39652037663f50280ce7ec755/kociemba/kociembaHls/solution1/.autopilot/db/prunetable_helpers.pragma.1.cpp" 2
# 1 "prunetable_helpers.cpp"
# 1 "prunetable_helpers.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 155 "<built-in>" 3
# 1 "<command line>" 1
...
# 6 "prunetable_helpers.cpp" 2
# 1 "./prunetable_helpers.h" 1
# 13 "./prunetable_helpers.h"
...
int make_dir(const char *cache_dir)
{
    ...
    return mkdir(cache_dir, (0400|0200|0100) | ((0400|0200|0100) >> 3) | ((0400 >> 3) >> 3) | ((0100 >> 3) >> 3));
...
void dump_to_file(void* ptr, int len, const char* name, const char *cache_dir)
{
    ...
    if (status == 0 || (*__errno_location ()) == 17) {
        char *fname = join_path(cache_dir, name);
        if (fname == __null) {
            fprintf(stderr, "Path to cache tables is too long\n");
        } else {
