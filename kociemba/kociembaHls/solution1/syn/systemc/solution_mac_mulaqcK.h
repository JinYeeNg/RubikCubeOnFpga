...
#ifndef __solution_mac_mulaqcK__HH__
#define __solution_mac_mulaqcK__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(solution_mac_mulaqcK) {
    ...
    SC_CTOR(solution_mac_mulaqcK):  simcore_mac_0_U ("simcore_mac_0_U") {
