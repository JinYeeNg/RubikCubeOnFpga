...
const sc_lv<11> getPruning_1::ap_ST_fsm_state1 = "1";
const sc_lv<11> getPruning_1::ap_ST_fsm_state2 = "10";
const sc_lv<11> getPruning_1::ap_ST_fsm_state3 = "100";
const sc_lv<11> getPruning_1::ap_ST_fsm_state4 = "1000";
const sc_lv<11> getPruning_1::ap_ST_fsm_state5 = "10000";
const sc_lv<11> getPruning_1::ap_ST_fsm_state6 = "100000";
const sc_lv<11> getPruning_1::ap_ST_fsm_state7 = "1000000";
const sc_lv<11> getPruning_1::ap_ST_fsm_state8 = "10000000";
const sc_lv<11> getPruning_1::ap_ST_fsm_state9 = "100000000";
const sc_lv<11> getPruning_1::ap_ST_fsm_state10 = "1000000000";
const sc_lv<11> getPruning_1::ap_ST_fsm_state11 = "10000000000";
...
const sc_lv<32> getPruning_1::ap_const_lv32_2 = "10";
...
const sc_lv<32> getPruning_1::ap_const_lv32_A = "1010";
...
getPruning_1::getPruning_1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_141_reg_220 );
    sensitive << ( ap_CS_fsm_state11 );
    sensitive << ( tmp_203_fu_199_p4 );
    sensitive << ( tmp_145_fu_209_p1 );
    ...
    SC_METHOD(thread_tmp_141_fu_78_p1);
    sensitive << ( index );

    SC_METHOD(thread_tmp_142_fu_82_p3);
    sensitive << ( index );

    SC_METHOD(thread_tmp_143_fu_156_p1);
    sensitive << ( tmp_s_fu_138_p3 );

    SC_METHOD(thread_tmp_144_fu_183_p3);
    sensitive << ( tmp_143_reg_230 );

    SC_METHOD(thread_tmp_145_fu_209_p1);
    sensitive << ( table_load5_fu_194_p2 );

    SC_METHOD(thread_tmp_200_fu_160_p1);
    sensitive << ( tmp_reg_225 );

    SC_METHOD(thread_tmp_201_fu_163_p1);
    sensitive << ( tmp_200_fu_160_p1 );

    SC_METHOD(thread_tmp_202_fu_190_p1);
    sensitive << ( tmp_144_fu_183_p3 );

    SC_METHOD(thread_tmp_203_fu_199_p4);
    sensitive << ( table_load5_fu_194_p2 );

    SC_METHOD(thread_tmp_42_fu_96_p4);
    sensitive << ( p_neg_fu_90_p2 );

    SC_METHOD(thread_tmp_43_fu_106_p1);
    sensitive << ( tmp_42_fu_96_p4 );

    SC_METHOD(thread_tmp_45_fu_120_p4);
    sensitive << ( index );

    SC_METHOD(thread_tmp_46_fu_130_p1);
    sensitive << ( tmp_45_fu_120_p4 );

    SC_METHOD(thread_tmp_s_fu_138_p3);
    sensitive << ( tmp_142_fu_82_p3 );
    ...
    sc_trace(mVcdFile, tmp_141_fu_78_p1, "tmp_141_fu_78_p1");
    sc_trace(mVcdFile, tmp_141_reg_220, "tmp_141_reg_220");
    sc_trace(mVcdFile, tmp_reg_225, "tmp_reg_225");
    sc_trace(mVcdFile, tmp_143_fu_156_p1, "tmp_143_fu_156_p1");
    sc_trace(mVcdFile, tmp_143_reg_230, "tmp_143_reg_230");
    ...
    sc_trace(mVcdFile, tmp_42_fu_96_p4, "tmp_42_fu_96_p4");
    sc_trace(mVcdFile, tmp_43_fu_106_p1, "tmp_43_fu_106_p1");
    sc_trace(mVcdFile, p_lshr_fu_110_p1, "p_lshr_fu_110_p1");
    sc_trace(mVcdFile, tmp_45_fu_120_p4, "tmp_45_fu_120_p4");
    sc_trace(mVcdFile, tmp_46_fu_130_p1, "tmp_46_fu_130_p1");
    sc_trace(mVcdFile, tmp_142_fu_82_p3, "tmp_142_fu_82_p3");
    ...
    sc_trace(mVcdFile, tmp_200_fu_160_p1, "tmp_200_fu_160_p1");
    sc_trace(mVcdFile, tmp_201_fu_163_p1, "tmp_201_fu_163_p1");
    sc_trace(mVcdFile, sext_fu_167_p1, "sext_fu_167_p1");
    sc_trace(mVcdFile, ap_CS_fsm_state11, "ap_CS_fsm_state11");
    sc_trace(mVcdFile, tmp_144_fu_183_p3, "tmp_144_fu_183_p3");
    sc_trace(mVcdFile, tmp_202_fu_190_p1, "tmp_202_fu_190_p1");
    sc_trace(mVcdFile, table_load5_fu_194_p2, "table_load5_fu_194_p2");
    sc_trace(mVcdFile, tmp_203_fu_199_p4, "tmp_203_fu_199_p4");
    sc_trace(mVcdFile, tmp_145_fu_209_p1, "tmp_145_fu_209_p1");
...
void getPruning_1::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        tmp_141_reg_220 = tmp_141_fu_78_p1.read();
        tmp_143_reg_230 = tmp_143_fu_156_p1.read();
...
void getPruning_1::thread_ap_CS_fsm_state11() {
...
void getPruning_1::thread_ap_CS_fsm_state3() {
...
void getPruning_1::thread_ap_return() {
    ap_return = (!tmp_141_reg_220.read()[0].is_01())? sc_lv<4>(): ((tmp_141_reg_220.read()[0].to_bool())? tmp_203_fu_199_p4.read(): tmp_145_fu_209_p1.read());
}
...
void getPruning_1::thread_p_lshr_f_fu_134_p1() {
    p_lshr_f_fu_134_p1 = esl_zext<32,31>(tmp_46_fu_130_p1.read());
}

void getPruning_1::thread_p_lshr_fu_110_p1() {
    p_lshr_fu_110_p1 = esl_zext<32,31>(tmp_43_fu_106_p1.read());
}
...
void getPruning_1::thread_sext_fu_167_p1() {
    sext_fu_167_p1 = esl_zext<64,31>(table_offset.read());
}

void getPruning_1::thread_sum_fu_171_p2() {
    sum_fu_171_p2 = (!tmp_201_fu_163_p1.read().is_01() || !sext_fu_167_p1.read().is_01())? sc_lv<64>(): (sc_biguint<64>(tmp_201_fu_163_p1.read()) + sc_biguint<64>(sext_fu_167_p1.read()));
}

void getPruning_1::thread_table_load5_fu_194_p2() {
    table_load5_fu_194_p2 = (!tmp_202_fu_190_p1.read().is_01())? sc_lv<16>(): table_addr_read_reg_241.read() >> (unsigned short)tmp_202_fu_190_p1.read().to_uint();
}
...
void getPruning_1::thread_tmp_141_fu_78_p1() {
    tmp_141_fu_78_p1 = index.read().range(1-1, 0);
}

void getPruning_1::thread_tmp_142_fu_82_p3() {
    tmp_142_fu_82_p3 = index.read().range(24, 24);
}

void getPruning_1::thread_tmp_143_fu_156_p1() {
    tmp_143_fu_156_p1 = tmp_s_fu_138_p3.read().range(1-1, 0);
}

void getPruning_1::thread_tmp_144_fu_183_p3() {
    tmp_144_fu_183_p3 = esl_concat<1,3>(tmp_143_reg_230.read(), ap_const_lv3_0);
}

void getPruning_1::thread_tmp_145_fu_209_p1() {
    tmp_145_fu_209_p1 = table_load5_fu_194_p2.read().range(4-1, 0);
}

void getPruning_1::thread_tmp_200_fu_160_p1() {
    tmp_200_fu_160_p1 = esl_sext<63,31>(tmp_reg_225.read());
}

void getPruning_1::thread_tmp_201_fu_163_p1() {
    tmp_201_fu_163_p1 = esl_zext<64,63>(tmp_200_fu_160_p1.read());
}

void getPruning_1::thread_tmp_202_fu_190_p1() {
    tmp_202_fu_190_p1 = esl_zext<16,4>(tmp_144_fu_183_p3.read());
}

void getPruning_1::thread_tmp_203_fu_199_p4() {
    tmp_203_fu_199_p4 = table_load5_fu_194_p2.read().range(7, 4);
}

void getPruning_1::thread_tmp_42_fu_96_p4() {
    tmp_42_fu_96_p4 = p_neg_fu_90_p2.read().range(24, 1);
}

void getPruning_1::thread_tmp_43_fu_106_p1() {
    tmp_43_fu_106_p1 = esl_sext<31,24>(tmp_42_fu_96_p4.read());
}

void getPruning_1::thread_tmp_45_fu_120_p4() {
    tmp_45_fu_120_p4 = index.read().range(24, 1);
}

void getPruning_1::thread_tmp_46_fu_130_p1() {
    tmp_46_fu_130_p1 = esl_sext<31,24>(tmp_45_fu_120_p4.read());
}

void getPruning_1::thread_tmp_s_fu_138_p3() {
    tmp_s_fu_138_p3 = (!tmp_142_fu_82_p3.read()[0].is_01())? sc_lv<32>(): ((tmp_142_fu_82_p3.read()[0].to_bool())? p_neg_t_fu_114_p2.read(): p_lshr_f_fu_134_p1.read());
}
