...
#ifndef __solution_mac_mulasc4__HH__
#define __solution_mac_mulasc4__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(solution_mac_mulasc4) {
    ...
    SC_CTOR(solution_mac_mulasc4):  simcore_mac_1_U ("simcore_mac_1_U") {
