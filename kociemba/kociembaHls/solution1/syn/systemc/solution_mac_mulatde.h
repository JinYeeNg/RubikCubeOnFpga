...
#ifndef __solution_mac_mulatde__HH__
#define __solution_mac_mulatde__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(solution_mac_mulatde) {
    ...
    SC_CTOR(solution_mac_mulatde):  simcore_mac_2_U ("simcore_mac_2_U") {
