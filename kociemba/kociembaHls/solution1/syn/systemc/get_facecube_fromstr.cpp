...
get_facecube_fromstr::get_facecube_fromstr(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_i_21_fu_137_p2);
    sensitive << ( i_reg_120 );
    ...
    sc_trace(mVcdFile, i_21_fu_137_p2, "i_21_fu_137_p2");
    sc_trace(mVcdFile, i_21_reg_151, "i_21_reg_151");
...
void get_facecube_fromstr::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        i_reg_120 = i_21_reg_151.read();
    } else if ((esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1) && 
                esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
        i_reg_120 = ap_const_lv6_0;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        i_21_reg_151 = i_21_fu_137_p2.read();
    }
...
void get_facecube_fromstr::thread_i_21_fu_137_p2() {
    i_21_fu_137_p2 = (!i_reg_120.read().is_01() || !ap_const_lv6_1.is_01())? sc_lv<6>(): (sc_biguint<6>(i_reg_120.read()) + sc_biguint<6>(ap_const_lv6_1));
}
