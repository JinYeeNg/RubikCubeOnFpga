...
HD_PWD='C:/Users/jinyee/RubikCube/Rubik_Cube_Layer_All_hlx/Rubik_Cube_Layer_All_hlx.runs/design_1_solveCube_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_solveCube_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_solveCube_0_0.tcl
